...
<body>
<?php include "sendSellRequestCode.php" ; ?>
    <h1>Varsity Books </h1>
    ...
    <button type="submit" class="signupbtn" name="AddBook"> Send Sell Request</button><button class="cancelbtn" type="button"><a href="sellBooks.php">  Cancel Request </a></button>
