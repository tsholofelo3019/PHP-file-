...
<?php include "addUserCode.php" ; ?>
    ...
    <button type="submit" class="signupbtn" name="AddUser"> AddUser</button><button class="cancelbtn" type="button"><a href="viewUsers.php">  Back to View User </a></button>
